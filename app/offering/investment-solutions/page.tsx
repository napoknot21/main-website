        ...
        <section className="relative pt-36 pb-20 bg-primary overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-6xl px-6 text-center">
            ...
            <p className="text-sm sm:text-base text-primary-foreground/60 max-w-lg mx-auto leading-relaxed">
              {t("offering.investment.subtitle")}
            </p>
          </div>
        </section>
        ...
        <section className="py-20 md:py-28 bg-background">
          <div className="mx-auto max-w-6xl px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
              {[
                { icon: TrendingUp, title: t("offering.investment.card1.title"), desc: t("offering.investment.card1.desc") },
                { icon: Layers, title: t("offering.investment.card2.title"), desc: t("offering.investment.card2.desc") },
                { icon: Users, title: t("offering.investment.card3.title"), desc: t("offering.investment.card3.desc") },
