        ...
        <section className="py-20 md:py-28 bg-background">
          <div className="mx-auto max-w-6xl px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
              {[
                { icon: Shield, title: t("offering.aif.card1.title"), desc: t("offering.aif.card1.desc") },
                { icon: BarChart3, title: t("offering.aif.card2.title"), desc: t("offering.aif.card2.desc") },
                { icon: Globe, title: t("offering.aif.card3.title"), desc: t("offering.aif.card3.desc") },
