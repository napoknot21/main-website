...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "footer.lux.address": "2, Boulevard de la Foire",
    "footer.lux.city": "L-1528 Luxembourg",
    "footer.lux.tel": "+352 26 20 26 1",
    "footer.lux.email": "info@heroicscapital.lu",
    "footer.monaco.title": "Heroics Capital Monaco",
    "footer.monaco.address": "27, Boulevard Albert 1er",
    "footer.monaco.city": "MC-98000 Monaco",
    "footer.monaco.tel": "+377 97 70 12 00",
    "footer.monaco.email": "info@heroicscapital.mc",
  ...
  es: {
    ...
    "footer.lux.address": "2, Boulevard de la Foire",
    "footer.lux.city": "L-1528 Luxemburgo",
    "footer.lux.tel": "+352 26 20 26 1",
    "footer.lux.email": "info@heroicscapital.lu",
    "footer.monaco.title": "Heroics Capital Monaco",
    "footer.monaco.address": "27, Boulevard Albert 1er",
