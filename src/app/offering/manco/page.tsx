          ...
          <div className="mx-auto max-w-6xl px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {services.map(({ key, icon: Icon }, idx) => (
                <div
                  key={key}
                  className={`flex flex-col p-7 rounded-xl border border-border bg-background hover:border-accent/30 hover:shadow-sm transition-all duration-700 ${
          ...
          <div className="mx-auto max-w-6xl px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {platforms.map(({ key, icon: Icon }, idx) => (
                <div
                  key={key}
                  className={`relative flex flex-col p-8 rounded-xl border border-border bg-background overflow-hidden group transition-all duration-700 ${
                    platformsSection.inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                  }`}
